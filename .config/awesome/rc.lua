...
vicious.register(pacmanwidget, vicious.widgets.pkg, "Updates: $1", 1800, "Arch")
...
beautiful.init("/home/stepan/.config/awesome/theme.lua")
...
date = awful.widget.textclock(" %a/%d/%b")
actuallyclock = awful.widget.textclock(" %H:%M")
...
globalkeys = gears.table.join(
	...
	--xscreensaver
	awful.key({ modkey },            "v",     function () awful.util.spawn("light-locker-command --lock") end,
    ...
    awful.key({ modkey },            "b",     function () awful.util.spawn("chromium") end,
              {description = "run chromium", group = "applictions"}),
    -- Menubar
...
-- Autostart
awful.spawn.with_shell("xrandr --output HDMI-1 --off")
awful.spawn.with_shell("picom -CGb --vsync --backend glx")
awful.spawn.with_shell("setxkbmap -layout 'us,ru' -option 'grp:alt_shift_toggle'")
awful.spawn.with_shell("numlockx &")
awful.spawn.with_shell("/usr/bin/light-locker")
